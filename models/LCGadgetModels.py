...
class LCNEGadget(nn.Module):
    """A neuro-inspired differentiable LC-NE gadget that produces modulating signals"""
...
class LSTMGadgetController(nn.Module):
    """LSTM that learns to use an LC-NE neuromodulation gadget"""
    def __init__(self, input_dim, hidden_dim):
        super(LSTMGadgetController, self).__init__()
        self.hidden_dim = hidden_dim
